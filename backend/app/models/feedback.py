...
class ExerciseFeedback(Base):
    ...
    context_type: Mapped[FeedbackContextType] = mapped_column(
        SAEnum(FeedbackContextType, name="feedbackcontexttype", values_callable=lambda obj: [e.value for e in obj]),
        nullable=False,
    )
