...
- [x] File created with 5 parameterized test cases <!-- Completed: 2026-06-06 -->
...
- [x] All 5 cases pass — contraindicated exercises never appear in output <!-- Completed: 2026-06-06 -->
...
- [x] `backend/tests/test_kg_critical_injury_filtering.py` exists with ≥5 parameterized test cases <!-- Completed: 2026-06-06 -->
- [x] All cases pass: no contraindicated exercise appears in the recommendation <!-- Completed: 2026-06-06 -->
- [x] Case 4 (all contraindicated) triggers fallback and produces empty/fallback recommendation <!-- Completed: 2026-06-06 -->
- [x] `skipped_exercise_ids` accurately reflects removed exercises <!-- Completed: 2026-06-06 -->

---
**UAT**: [`.docs/uat/completed/068-critical-path-test-injury-filtering.uat.md`](../uat/completed/068-critical-path-test-injury-filtering.uat.md)
